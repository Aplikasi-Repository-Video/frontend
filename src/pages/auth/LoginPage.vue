<template>
  <div class="min-h-screen flex">
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
      <div
        class="absolute inset-0 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700"
      ></div>
      ...
      ></div>
      <div
        class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400 bg-opacity-10 rounded-full blur-3xl animate-pulse delay-1000"
      ></div>
      ...
      <div class="relative z-10 flex flex-col justify-center items-start p-12 text-white">
        <div class="mb-8">
          ...
          <p class="text-lg text-gray-200 mb-8 leading-relaxed">
            Lanjutkan perjalanan belajar Anda dengan ribuan video edukatif berkualitas tinggi. Dari
            pemula hingga mahir, semua ada di sini.
          </p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6 w-full max-w-sm">
          <div class="text-center">
            ...
            <div class="text-sm text-gray-300">Video Tersedia</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-green-400">100K+</div>
            <div class="text-sm text-gray-300">Siswa Aktif</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div
      class="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-br from-slate-100 via-purple-100 to-slate-100 p-8"
    >
...
watch(email, (newEmail) => {
  emailError.value = newEmail && !isValidEmail(newEmail) ? 'Please enter a valid email address' : ''
})

watch(password, (newPassword) => {
  passwordError.value = newPassword && newPassword.length < 1 ? 'Password is required' : ''
})
